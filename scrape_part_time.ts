...
const searchCriteria = ["Angular", "Programátor", "Vývojář", "React", "Web developer", "Developer", "Software Developer", "HTML", "Javascript", "Typescript", "Software Engineer", "Frontend", "Datový analytik", "Databáze", "SQL", "SW", "Backend"]
...
async function applySearchCriteria() {
    ...
    const jobsFilteredForbiddenJobs = jobsFiltered.filter(job => {
